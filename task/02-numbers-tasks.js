...
function getAverage(value1, value2) {
    return ((value1+value2)/2 != Infinity) ? (value1+value2)/2 : Number.MAX_VALUE;
}
...
function getDistanceBetweenPoints(x1, y1, x2, y2) {
    return Math.sqrt(getSquad(x2, x1)+getSquad(y2, y1));
}

function getSquad(a, b){
...
function toNumber(value, def) {
    return (parseInt(value)) ? Number(value) : def;
}
